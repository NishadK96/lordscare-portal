...
export function PublicSupport() {
  ...
  return <main className="public-support">
    ...
    <section className="support-shell setup-promo"><div className="setup-promo-icon"><Settings2 /></div><div><p className="eyebrow">New guided request</p><h2>Tell us how you want your bot configured</h2><p>Select your preferred building, research, familiar, and army-training settings. We will receive one clear setup summary—no login or password required.</p></div><a className="primary-button" href="/setup-request">Create setup request<ClipboardList size={17} /></a></section>
