...
export function PublicSupport() {
  ...
  return <main className="public-support">
    <header className="support-site-header"><div className="support-shell support-nav"><a href="/" className="site-brand" aria-label="LordsCare support home"><div className="brand-mark">LC</div><div><strong>LordsCare</strong><span>Subscriber Support</span></div></a><nav><a href="/events"><CalendarDays size={14} />Events</a><a href="#commands">Commands</a><a href="https://help.lords-bot.com/faq/guild-bank-commands/" target="_blank" rel="noreferrer">Official guide<ExternalLink size={14} /></a></nav></div></header>
